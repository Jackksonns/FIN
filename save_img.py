...
if __name__ == "__main__":
    input_root = r"E:\research1yh_run\gtos_128128_all\train"
    output_root = r"E:\research1yh_run\FINsavimg_pnsr35_gtos_128128\train"
    batch_size = 32
    num_workers = 4
    ...
    # fed.cuda()
    model_path = r"E:\research1yh_run\FINparameter\fed_12_psnr-35.61181.pt"
    
    load(fed, r"E:\research1yh_run\FINparameter\fed_12_psnr-35.61181.pt")
   

    

    # checkpoint = torch.load(r"E:\research1yh_run\FINparameter\fed_12_psnr-35.61181.pt")
    # model_from_checkpoint(models, checkpoint)
    # encoder = models.encoder_decoder.encoder
    # encoder.eval()
    ...
    batch_process(fed, dataloader, output_root, device)